...
const char* get_help_header() {
    return (current_lang == LANG_PT) 
        ? "=== RUDIS " VERSION " - SISTEMA DE AJUDA ==="
        : "=== RUDIS " VERSION " - HELP SYSTEM ===";
}
...
// =============================================================================
// TRADUÇÕES PARA FUNÇÕES DE CORES E ESTILOS (COMPLETO - 34 FUNÇÕES)
// =============================================================================

// CORES DO TEXTO (16 funções)
const char* get_help_function_black() {
    return (current_lang == LANG_PT) 
        ? "Função: black (Preto)\nSintaxe: black(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em preto\nExemplo: black(\"Texto\") retorna texto preto\nAplicação: Texto discreto, contraste"
        : "Function: black (Black)\nSyntax: black(text)\nParameters: text - string to color\nReturns: Text in black\nExample: black(\"Text\") returns black text\nApplication: Discrete text, contrast";
}

const char* get_help_function_red() {
    return (current_lang == LANG_PT) 
        ? "Função: red (Vermelho)\nSintaxe: red(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em vermelho\nExemplo: red(\"Erro!\") retorna texto vermelho\nAplicação: Erros, alertas importantes"
        : "Function: red (Red)\nSyntax: red(text)\nParameters: text - string to color\nReturns: Text in red\nExample: red(\"Error!\") returns red text\nApplication: Errors, important alerts";
}

const char* get_help_function_green() {
    return (current_lang == LANG_PT) 
        ? "Função: green (Verde)\nSintaxe: green(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em verde\nExemplo: green(\"Sucesso!\") retorna texto verde\nAplicação: Sucesso, confirmações"
        : "Function: green (Green)\nSyntax: green(text)\nParameters: text - string to color\nReturns: Text in green\nExample: green(\"Success!\") returns green text\nApplication: Success, confirmations";
}

const char* get_help_function_yellow() {
    return (current_lang == LANG_PT) 
        ? "Função: yellow (Amarelo)\nSintaxe: yellow(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em amarelo\nExemplo: yellow(\"Aviso\") retorna texto amarelo\nAplicação: Avisos, precauções"
        : "Function: yellow (Yellow)\nSyntax: yellow(text)\nParameters: text - string to color\nReturns: Text in yellow\nExample: yellow(\"Warning\") returns yellow text\nApplication: Warnings, precautions";
}

const char* get_help_function_blue() {
    return (current_lang == LANG_PT) 
        ? "Função: blue (Azul)\nSintaxe: blue(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em azul\nExemplo: blue(\"Informação\") retorna texto azul\nAplicação: Informações, links"
        : "Function: blue (Blue)\nSyntax: blue(text)\nParameters: text - string to color\nReturns: Text in blue\nExample: blue(\"Information\") returns blue text\nApplication: Information, links";
}

const char* get_help_function_magenta() {
    return (current_lang == LANG_PT) 
        ? "Função: magenta (Magenta)\nSintaxe: magenta(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em magenta\nExemplo: magenta(\"Destaque\") retorna texto magenta\nAplicação: Destaques especiais"
        : "Function: magenta (Magenta)\nSyntax: magenta(text)\nParameters: text - string to color\nReturns: Text in magenta\nExample: magenta(\"Highlight\") returns magenta text\nApplication: Special highlights";
}

const char* get_help_function_cyan() {
    return (current_lang == LANG_PT) 
        ? "Função: cyan (Ciano)\nSintaxe: cyan(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em ciano\nExemplo: cyan(\"Nota\") retorna texto ciano\nAplicação: Notas, explicações"
        : "Function: cyan (Cyan)\nSyntax: cyan(text)\nParameters: text - string to color\nReturns: Text in cyan\nExample: cyan(\"Note\") returns cyan text\nApplication: Notes, explanations";
}

const char* get_help_function_white() {
    return (current_lang == LANG_PT) 
        ? "Função: white (Branco)\nSintaxe: white(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em branco\nExemplo: white(\"Texto\") retorna texto branco\nAplicação: Texto normal, padrão"
        : "Function: white (White)\nSyntax: white(text)\nParameters: text - string to color\nReturns: Text in white\nExample: white(\"Text\") returns white text\nApplication: Normal text, default";
}

const char* get_help_function_bright_black() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_black (Preto Brilhante)\nSintaxe: bright_black(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em preto brilhante\nExemplo: bright_black(\"Cinza\") retorna texto preto brilhante\nAplicação: Texto secundário"
        : "Function: bright_black (Bright Black)\nSyntax: bright_black(text)\nParameters: text - string to color\nReturns: Text in bright black\nExample: bright_black(\"Gray\") returns bright black text\nApplication: Secondary text";
}

const char* get_help_function_bright_red() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_red (Vermelho Brilhante)\nSintaxe: bright_red(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em vermelho brilhante\nExemplo: bright_red(\"ALERTA!\") retorna texto vermelho brilhante\nAplicação: Alertas urgentes"
        : "Function: bright_red (Bright Red)\nSyntax: bright_red(text)\nParameters: text - string to color\nReturns: Text in bright red\nExample: bright_red(\"ALERT!\") returns bright red text\nApplication: Urgent alerts";
}

const char* get_help_function_bright_green() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_green (Verde Brilhante)\nSintaxe: bright_green(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em verde brilhante\nExemplo: bright_green(\"PRONTO!\") retorna texto verde brilhante\nAplicação: Confirmações fortes"
        : "Function: bright_green (Bright Green)\nSyntax: bright_green(text)\nParameters: text - string to color\nReturns: Text in bright green\nExample: bright_green(\"READY!\") returns bright green text\nApplication: Strong confirmations";
}

const char* get_help_function_bright_yellow() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_yellow (Amarelo Brilhante)\nSintaxe: bright_yellow(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em amarelo brilhante\nExemplo: bright_yellow(\"ATENÇÃO!\") retorna texto amarelo brilhante\nAplicação: Avisos importantes"
        : "Function: bright_yellow (Bright Yellow)\nSyntax: bright_yellow(text)\nParameters: text - string to color\nReturns: Text in bright yellow\nExample: bright_yellow(\"ATTENTION!\") returns bright yellow text\nApplication: Important warnings";
}

const char* get_help_function_bright_blue() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_blue (Azul Brilhante)\nSintaxe: bright_blue(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em azul brilhante\nExemplo: bright_blue(\"INFO\") retorna texto azul brilhante\nAplicação: Informações destacadas"
        : "Function: bright_blue (Bright Blue)\nSyntax: bright_blue(text)\nParameters: text - string to color\nReturns: Text in bright blue\nExample: bright_blue(\"INFO\") returns bright blue text\nApplication: Highlighted information";
}

const char* get_help_function_bright_magenta() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_magenta (Magenta Brilhante)\nSintaxe: bright_magenta(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em magenta brilhante\nExemplo: bright_magenta(\"ESPECIAL\") retorna texto magenta brilhante\nAplicação: Destaques especiais"
        : "Function: bright_magenta (Bright Magenta)\nSyntax: bright_magenta(text)\nParameters: text - string to color\nReturns: Text in bright magenta\nExample: bright_magenta(\"SPECIAL\") returns bright magenta text\nApplication: Special highlights";
}

const char* get_help_function_bright_cyan() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_cyan (Ciano Brilhante)\nSintaxe: bright_cyan(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em ciano brilhante\nExemplo: bright_cyan(\"DETALHE\") retorna texto ciano brilhante\nAplicação: Detalhes importantes"
        : "Function: bright_cyan (Bright Cyan)\nSyntax: bright_cyan(text)\nParameters: text - string to color\nReturns: Text in bright cyan\nExample: bright_cyan(\"DETAIL\") returns bright cyan text\nApplication: Important details";
}

const char* get_help_function_bright_white() {
    return (current_lang == LANG_PT) 
        ? "Função: bright_white (Branco Brilhante)\nSintaxe: bright_white(texto)\nParâmetros: texto - string para colorir\nRetorna: Texto em branco brilhante\nExemplo: bright_white(\"TEXTO\") retorna texto branco brilhante\nAplicação: Texto muito destacado"
        : "Function: bright_white (Bright White)\nSyntax: bright_white(text)\nParameters: text - string to color\nReturns: Text in bright white\nExample: bright_white(\"TEXT\") returns bright white text\nApplication: Highly highlighted text";
}

// CORES DE FUNDO (16 funções)
const char* get_help_function_bg_black() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_black (Fundo Preto)\nSintaxe: bg_black(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo preto\nExemplo: bg_black(\" \") retorna fundo preto\nAplicação: Destaques escuros"
        : "Function: bg_black (Black Background)\nSyntax: bg_black(text)\nParameters: text - string to apply background\nReturns: Text with black background\nExample: bg_black(\" \") returns black background\nApplication: Dark highlights";
}

const char* get_help_function_bg_red() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_red (Fundo Vermelho)\nSintaxe: bg_red(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo vermelho\nExemplo: bg_red(\" ERRO \") destaca erro\nAplicação: Alertas visuais"
        : "Function: bg_red (Red Background)\nSyntax: bg_red(text)\nParameters: text - string to apply background\nReturns: Text with red background\nExample: bg_red(\" ERROR \") highlights error\nApplication: Visual alerts";
}

const char* get_help_function_bg_green() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_green (Fundo Verde)\nSintaxe: bg_green(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo verde\nExemplo: bg_green(\" OK \") destaca sucesso\nAplicação: Confirmações visuais"
        : "Function: bg_green (Green Background)\nSyntax: bg_green(text)\nParameters: text - string to apply background\nReturns: Text with green background\nExample: bg_green(\" OK \") highlights success\nApplication: Visual confirmations";
}

const char* get_help_function_bg_yellow() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_yellow (Fundo Amarelo)\nSintaxe: bg_yellow(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo amarelo\nExemplo: bg_yellow(\" AVISO \") destaca aviso\nAplicação: Avisos visuais"
        : "Function: bg_yellow (Yellow Background)\nSyntax: bg_yellow(text)\nParameters: text - string to apply background\nReturns: Text with yellow background\nExample: bg_yellow(\" WARNING \") highlights warning\nApplication: Visual warnings";
}

const char* get_help_function_bg_blue() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_blue (Fundo Azul)\nSintaxe: bg_blue(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo azul\nExemplo: bg_blue(\" INFO \") destaca informação\nAplicação: Informações visuais"
        : "Function: bg_blue (Blue Background)\nSyntax: bg_blue(text)\nParameters: text - string to apply background\nReturns: Text with blue background\nExample: bg_blue(\" INFO \") highlights information\nApplication: Visual information";
}

const char* get_help_function_bg_magenta() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_magenta (Fundo Magenta)\nSintaxe: bg_magenta(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo magenta\nExemplo: bg_magenta(\" DESTAQUE \") destaca especial\nAplicação: Destaques especiais"
        : "Function: bg_magenta (Magenta Background)\nSyntax: bg_magenta(text)\nParameters: text - string to apply background\nReturns: Text with magenta background\nExample: bg_magenta(\" HIGHLIGHT \") special highlight\nApplication: Special highlights";
}

const char* get_help_function_bg_cyan() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_cyan (Fundo Ciano)\nSintaxe: bg_cyan(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo ciano\nExemplo: bg_cyan(\" NOTA \") destaca nota\nAplicação: Notas visuais"
        : "Function: bg_cyan (Cyan Background)\nSyntax: bg_cyan(text)\nParameters: text - string to apply background\nReturns: Text with cyan background\nExample: bg_cyan(\" NOTE \") highlights note\nApplication: Visual notes";
}

const char* get_help_function_bg_white() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_white (Fundo Branco)\nSintaxe: bg_white(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo branco\nExemplo: bg_white(black(\" TEXTO \")) contraste\nAplicação: Contraste, realce"
        : "Function: bg_white (White Background)\nSyntax: bg_white(text)\nParameters: text - string to apply background\nReturns: Text with white background\nExample: bg_white(black(\" TEXT \")) contrast\nApplication: Contrast, emphasis";
}

const char* get_help_function_bg_bright_black() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_black (Fundo Preto Brilhante)\nSintaxe: bg_bright_black(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo preto brilhante\nExemplo: bg_bright_black(\" \") fundo cinza\nAplicação: Fundos claros"
        : "Function: bg_bright_black (Bright Black Background)\nSyntax: bg_bright_black(text)\nParameters: text - string to apply background\nReturns: Text with bright black background\nExample: bg_bright_black(\" \") gray background\nApplication: Light backgrounds";
}

const char* get_help_function_bg_bright_red() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_red (Fundo Vermelho Brilhante)\nSintaxe: bg_bright_red(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo vermelho brilhante\nExemplo: bg_bright_red(\" URGENTE \") alerta forte\nAplicação: Alertas fortes"
        : "Function: bg_bright_red (Bright Red Background)\nSyntax: bg_bright_red(text)\nParameters: text - string to apply background\nReturns: Text with bright red background\nExample: bg_bright_red(\" URGENT \") strong alert\nApplication: Strong alerts";
}

const char* get_help_function_bg_bright_green() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_green (Fundo Verde Brilhante)\nSintaxe: bg_bright_green(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo verde brilhante\nExemplo: bg_bright_green(\" CONCLUÍDO \") sucesso forte\nAplicação: Confirmações fortes"
        : "Function: bg_bright_green (Bright Green Background)\nSyntax: bg_bright_green(text)\nParameters: text - string to apply background\nReturns: Text with bright green background\nExample: bg_bright_green(\" COMPLETED \") strong success\nApplication: Strong confirmations";
}

const char* get_help_function_bg_bright_yellow() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_yellow (Fundo Amarelo Brilhante)\nSintaxe: bg_bright_yellow(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo amarelo brilhante\nExemplo: bg_bright_yellow(\" CUIDADO! \") aviso forte\nAplicação: Avisos fortes"
        : "Function: bg_bright_yellow (Bright Yellow Background)\nSyntax: bg_bright_yellow(text)\nParameters: text - string to apply background\nReturns: Text with bright yellow background\nExample: bg_bright_yellow(\" CAUTION! \") strong warning\nApplication: Strong warnings";
}

const char* get_help_function_bg_bright_blue() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_blue (Fundo Azul Brilhante)\nSintaxe: bg_bright_blue(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo azul brilhante\nExemplo: bg_bright_blue(\" IMPORTANTE \") info forte\nAplicação: Informações fortes"
        : "Function: bg_bright_blue (Bright Blue Background)\nSyntax: bg_bright_blue(text)\nParameters: text - string to apply background\nReturns: Text with bright blue background\nExample: bg_bright_blue(\" IMPORTANT \") strong info\nApplication: Strong information";
}

const char* get_help_function_bg_bright_magenta() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_magenta (Fundo Magenta Brilhante)\nSintaxe: bg_bright_magenta(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo magenta brilhante\nExemplo: bg_bright_magenta(\" ESPECIAL! \") destaque forte\nAplicação: Destaques fortes"
        : "Function: bg_bright_magenta (Bright Magenta Background)\nSyntax: bg_bright_magenta(text)\nParameters: text - string to apply background\nReturns: Text with bright magenta background\nExample: bg_bright_magenta(\" SPECIAL! \") strong highlight\nApplication: Strong highlights";
}

const char* get_help_function_bg_bright_cyan() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_cyan (Fundo Ciano Brilhante)\nSintaxe: bg_bright_cyan(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo ciano brilhante\nExemplo: bg_bright_cyan(\" DETALHE \") detalhe forte\nAplicação: Detalhes fortes"
        : "Function: bg_bright_cyan (Bright Cyan Background)\nSyntax: bg_bright_cyan(text)\nParameters: text - string to apply background\nReturns: Text with bright cyan background\nExample: bg_bright_cyan(\" DETAIL \") strong detail\nApplication: Strong details";
}

const char* get_help_function_bg_bright_white() {
    return (current_lang == LANG_PT) 
        ? "Função: bg_bright_white (Fundo Branco Brilhante)\nSintaxe: bg_bright_white(texto)\nParâmetros: texto - string para aplicar fundo\nRetorna: Texto com fundo branco brilhante\nExemplo: bg_bright_white(black(\" MAXIMO \")) máximo contraste\nAplicação: Máximo contraste"
        : "Function: bg_bright_white (Bright White Background)\nSyntax: bg_bright_white(text)\nParameters: text - string to apply background\nReturns: Text with bright white background\nExample: bg_bright_white(black(\" MAXIMUM \")) maximum contrast\nApplication: Maximum contrast";
}

// ESTILOS DE TEXTO (8 funções)
const char* get_help_function_bold() {
    return (current_lang == LANG_PT) 
        ? "Função: bold (Negrito)\nSintaxe: bold(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto em negrito\nExemplo: bold(\"Importante\") texto em negrito\nAplicação: Ênfase, títulos"
        : "Function: bold (Bold)\nSyntax: bold(text)\nParameters: text - string to format\nReturns: Text in bold\nExample: bold(\"Important\") bold text\nApplication: Emphasis, titles";
}

const char* get_help_function_dim() {
    return (current_lang == LANG_PT) 
        ? "Função: dim (Atenuado)\nSintaxe: dim(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto atenuado (menos intenso)\nExemplo: dim(\"Secundário\") texto suave\nAplicação: Texto secundário, desativado"
        : "Function: dim (Dim)\nSyntax: dim(text)\nParameters: text - string to format\nReturns: Dim text (less intense)\nExample: dim(\"Secondary\") soft text\nApplication: Secondary text, disabled";
}

const char* get_help_function_italic() {
    return (current_lang == LANG_PT) 
        ? "Função: italic (Itálico)\nSintaxe: italic(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto em itálico\nExemplo: italic(\"Ênfase\") texto em itálico\nAplicação: Ênfase, citações"
        : "Function: italic (Italic)\nSyntax: italic(text)\nParameters: text - string to format\nReturns: Text in italic\nExample: italic(\"Emphasis\") italic text\nApplication: Emphasis, quotes";
}

const char* get_help_function_underline() {
    return (current_lang == LANG_PT) 
        ? "Função: underline (Sublinhado)\nSintaxe: underline(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto sublinhado\nExemplo: underline(\"Link\") texto sublinhado\nAplicação: Links, destaques"
        : "Function: underline (Underline)\nSyntax: underline(text)\nParameters: text - string to format\nReturns: Text underlined\nExample: underline(\"Link\") underlined text\nApplication: Links, highlights";
}

const char* get_help_function_blink() {
    return (current_lang == LANG_PT) 
        ? "Função: blink (Piscante)\nSintaxe: blink(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto piscante (nem todos os terminais)\nExemplo: blink(\"ALERTA\") texto piscante\nAplicação: Alertas urgentes (use com moderação)"
        : "Function: blink (Blink)\nSyntax: blink(text)\nParameters: text - string to format\nReturns: Blinking text (not all terminals)\nExample: blink(\"ALERT\") blinking text\nApplication: Urgent alerts (use sparingly)";
}

const char* get_help_function_inverse() {
    return (current_lang == LANG_PT) 
        ? "Função: inverse (Inverso)\nSintaxe: inverse(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto com cores invertidas\nExemplo: inverse(\"INVERTIDO\") cores invertidas\nAplicação: Destaque especial, códigos"
        : "Function: inverse (Inverse)\nSyntax: inverse(text)\nParameters: text - string to format\nReturns: Text with inverted colors\nExample: inverse(\"INVERTED\") inverted colors\nApplication: Special highlight, codes";
}

const char* get_help_function_hidden() {
    return (current_lang == LANG_PT) 
        ? "Função: hidden (Oculto)\nSintaxe: hidden(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto oculto (visível ao selecionar)\nExemplo: hidden(\"senha\") texto oculto\nAplicação: Senhas, informações sensíveis"
        : "Function: hidden (Hidden)\nSyntax: hidden(text)\nParameters: text - string to format\nReturns: Hidden text (visible when selected)\nExample: hidden(\"password\") hidden text\nApplication: Passwords, sensitive info";
}

const char* get_help_function_strikethrough() {
    return (current_lang == LANG_PT) 
        ? "Função: strikethrough (Tachado)\nSintaxe: strikethrough(texto)\nParâmetros: texto - string para formatar\nRetorna: Texto tachado\nExemplo: strikethrough(\"antigo\") texto tachado\nAplicação: Texto removido, desatualizado"
        : "Function: strikethrough (Strikethrough)\nSyntax: strikethrough(text)\nParameters: text - string to format\nReturns: Text strikethrough\nExample: strikethrough(\"old\") strikethrough text\nApplication: Removed text, outdated";
}
...
if (current_lang == LANG_PT) {
    ...
    printf("  * Funções de Cores        - black, red, green, yellow, blue, magenta, cyan, white\n");
    printf("  * Funções de Estilo       - bold, italic, underline, blink, inverse\n");
    printf("  * Funções de Fundo        - bg_*, ex: bg_red, bg_blue, bg_bright_*\n");
} else {
    printf("  * Basic Math              - +, -, *, /, %%, ^, !\n");
    ...
    printf("  * Color Functions         - black, red, green, yellow, blue, magenta, cyan, white\n");
    printf("  * Style Functions         - bold, italic, underline, blink, inverse\n");
    printf("  * Background Functions    - bg_*, ex: bg_red, bg_blue, bg_bright_*\n");
}
...
void print_function_help(const char* function_name) {
    ...
    // FUNÇÕES FINANCEIRAS AVANÇADAS
     ...
     // ============ FUNÇÕES DE CORES E ESTILOS ============
    // Cores do texto
    else if (strcmp(function_name, "black") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_black());
    }
    else if (strcmp(function_name, "red") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_red());
    }
    else if (strcmp(function_name, "green") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_green());
    }
    else if (strcmp(function_name, "yellow") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_yellow());
    }
    else if (strcmp(function_name, "blue") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_blue());
    }
    else if (strcmp(function_name, "magenta") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_magenta());
    }
    else if (strcmp(function_name, "cyan") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_cyan());
    }
    else if (strcmp(function_name, "white") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_white());
    }
    else if (strcmp(function_name, "bright_black") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_black());
    }
    else if (strcmp(function_name, "bright_red") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_red());
    }
    else if (strcmp(function_name, "bright_green") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_green());
    }
    else if (strcmp(function_name, "bright_yellow") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_yellow());
    }
    else if (strcmp(function_name, "bright_blue") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_blue());
    }
    else if (strcmp(function_name, "bright_magenta") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_magenta());
    }
    else if (strcmp(function_name, "bright_cyan") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_cyan());
    }
    else if (strcmp(function_name, "bright_white") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bright_white());
    }

    // Cores de fundo
    else if (strcmp(function_name, "bg_black") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_black());
    }
    else if (strcmp(function_name, "bg_red") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_red());
    }
    else if (strcmp(function_name, "bg_green") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_green());
    }
    else if (strcmp(function_name, "bg_yellow") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_yellow());
    }
    else if (strcmp(function_name, "bg_blue") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_blue());
    }
    else if (strcmp(function_name, "bg_magenta") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_magenta());
    }
    else if (strcmp(function_name, "bg_cyan") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_cyan());
    }
    else if (strcmp(function_name, "bg_white") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_white());
    }
    else if (strcmp(function_name, "bg_bright_black") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_black());
    }
    else if (strcmp(function_name, "bg_bright_red") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_red());
    }
    else if (strcmp(function_name, "bg_bright_green") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_green());
    }
    else if (strcmp(function_name, "bg_bright_yellow") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_yellow());
    }
    else if (strcmp(function_name, "bg_bright_blue") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_blue());
    }
    else if (strcmp(function_name, "bg_bright_magenta") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_magenta());
    }
    else if (strcmp(function_name, "bg_bright_cyan") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_cyan());
    }
    else if (strcmp(function_name, "bg_bright_white") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bg_bright_white());
    }

    // Estilos de texto
    else if (strcmp(function_name, "bold") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_bold());
    }
    else if (strcmp(function_name, "dim") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_dim());
    }
    else if (strcmp(function_name, "italic") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_italic());
    }
    else if (strcmp(function_name, "underline") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_underline());
    }
    else if (strcmp(function_name, "blink") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_blink());
    }
    else if (strcmp(function_name, "inverse") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_inverse());
    }
    else if (strcmp(function_name, "hidden") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_hidden());
    }
    else if (strcmp(function_name, "strikethrough") == 0) {
        printf(BOLD "%s\n" RESET, get_help_function_strikethrough());
    }
    else {
...
case 5:
    if (current_lang == LANG_PT) {
        printf(BOLD "=== FUNÇÕES DE CORES E ESTILOS ===\n\n" RESET);
        printf(BOLD "CORES DO TEXTO:\n" RESET);
        printf("  " BOLD "black" RESET "          - Preto\n");
        printf("  " BOLD "red" RESET "            - Vermelho\n");
        printf("  " BOLD "green" RESET "          - Verde\n");
        printf("  " BOLD "yellow" RESET "         - Amarelo\n");
        printf("  " BOLD "blue" RESET "           - Azul\n");
        printf("  " BOLD "magenta" RESET "        - Magenta\n");
        printf("  " BOLD "cyan" RESET "           - Ciano\n");
        printf("  " BOLD "white" RESET "          - Branco\n");
        
        printf("\n" BOLD "CORES BRILHANTES:\n" RESET);
        printf("  " BOLD "bright_*" RESET "       - Prefixo para cores brilhantes\n");
        printf("  Ex: " BOLD "bright_red" RESET " - Vermelho brilhante\n");
        
        printf("\n" BOLD "CORES DE FUNDO:\n" RESET);
        printf("  " BOLD "bg_*" RESET "           - Prefixo para cores de fundo\n");
        printf("  Ex: " BOLD "bg_red" RESET "     - Fundo vermelho\n");
        printf("  Ex: " BOLD "bg_bright_green" RESET " - Fundo verde brilhante\n");
        
        printf("\n" BOLD "ESTILOS DE TEXTO:\n" RESET);
        printf("  " BOLD "bold" RESET "           - Negrito\n");
        printf("  " BOLD "dim" RESET "            - Texto suave\n");
        printf("  " BOLD "italic" RESET "         - Itálico\n");
        printf("  " BOLD "underline" RESET "      - Sublinhado\n");
        printf("  " BOLD "blink" RESET "          - Piscante\n");
        printf("  " BOLD "inverse" RESET "        - Cores invertidas\n");
        printf("  " BOLD "hidden" RESET "         - Texto oculto\n");
        printf("  " BOLD "strikethrough" RESET "  - Tachado\n");
        
        printf("\n" BOLD "=== EXEMPLOS PRÁTICOS ===\n\n" RESET);
        printf("  > " BOLD "red(\"Erro!\")" RESET "\n");
        printf("  > " BOLD "green(\"Sucesso: \") + white(\"Operação completa\")" RESET "\n");
        printf("  > " BOLD "bold(yellow(\"ATENÇÃO!\"))" RESET "\n");
        printf("  > " BOLD "bg_red(white(\" ALERTA \"))" RESET "\n");
        printf("  > " BOLD "underline(blue(\"Clique aqui\"))" RESET "\n");
        
        printf("\n" BOLD "=== COMBINAÇÕES ===\n\n" RESET);
        printf("  As funções podem ser combinadas:\n");
        printf("  " BOLD "bold(red(\"ERRO CRÍTICO!\"))" RESET "\n");
        printf("  " BOLD "bg_yellow(black(\" AVISO \"))" RESET "\n");
    } else {
        printf(BOLD "=== COLOR AND STYLE FUNCTIONS ===\n\n" RESET);
        printf(BOLD "TEXT COLORS:\n" RESET);
        printf("  " BOLD "black" RESET "          - Black\n");
        printf("  " BOLD "red" RESET "            - Red\n");
        printf("  " BOLD "green" RESET "          - Green\n");
        printf("  " BOLD "yellow" RESET "         - Yellow\n");
        printf("  " BOLD "blue" RESET "           - Blue\n");
        printf("  " BOLD "magenta" RESET "        - Magenta\n");
        printf("  " BOLD "cyan" RESET "           - Cyan\n");
        printf("  " BOLD "white" RESET "          - White\n");
        
        printf("\n" BOLD "BRIGHT COLORS:\n" RESET);
        printf("  " BOLD "bright_*" RESET "       - Prefix for bright colors\n");
        printf("  Ex: " BOLD "bright_red" RESET " - Bright red\n");
        
        printf("\n" BOLD "BACKGROUND COLORS:\n" RESET);
        printf("  " BOLD "bg_*" RESET "           - Prefix for background colors\n");
        printf("  Ex: " BOLD "bg_red" RESET "     - Red background\n");
        printf("  Ex: " BOLD "bg_bright_green" RESET " - Bright green background\n");
        
        printf("\n" BOLD "TEXT STYLES:\n" RESET);
        printf("  " BOLD "bold" RESET "           - Bold\n");
        printf("  " BOLD "dim" RESET "            - Dim\n");
        printf("  " BOLD "italic" RESET "         - Italic\n");
        printf("  " BOLD "underline" RESET "      - Underline\n");
        printf("  " BOLD "blink" RESET "          - Blink\n");
        printf("  " BOLD "inverse" RESET "        - Inverse colors\n");
        printf("  " BOLD "hidden" RESET "         - Hidden text\n");
        printf("  " BOLD "strikethrough" RESET "  - Strikethrough\n");
        
        printf("\n" BOLD "=== PRACTICAL EXAMPLES ===\n\n" RESET);
        printf("  > " BOLD "red(\"Error!\")" RESET "\n");
        printf("  > " BOLD "green(\"Success: \") + white(\"Operation complete\")" RESET "\n");
        printf("  > " BOLD "bold(yellow(\"WARNING!\"))" RESET "\n");
        printf("  > " BOLD "bg_red(white(\" ALERT \"))" RESET "\n");
        printf("  > " BOLD "underline(blue(\"Click here\"))" RESET "\n");
        
        printf("\n" BOLD "=== COMBINATIONS ===\n\n" RESET);
        printf("  Functions can be combined:\n");
        printf("  " BOLD "bold(red(\"CRITICAL ERROR!\"))" RESET "\n");
        printf("  " BOLD "bg_yellow(black(\" WARNING \"))" RESET "\n");
    }
    break;
        default:
