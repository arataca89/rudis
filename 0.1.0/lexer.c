...
int is_function(const char* text) {
    ...
    const char* functions[] = {
        ...
        "left", "center", "right",  // Configura tamaho do campo e alinhamento do texto 
        ...
        "bg_cyan", "bg_white", "bg_bright_black", "bg_bright_red", "bg_bright_green",
...
int is_reserved_word(const char* text) {
    // LISTA DE PALAVRAS RESERVADAS DO RUDIS
    const char* reserved_words[] = {
        // ============ PALAVRAS-CHAVE DA LINGUAGEM (futuras) ============
        ...
        // ============ FUNÇÕES DE CORES (até agora) ============
        //"red",
        // "green", "blue", "yellow", "magenta", "cyan", "white",
        // "black", "bright_red", "bright_green", "bright_yellow",
        // "bright_blue", "bright_magenta", "bright_cyan", "bright_white",
        // "bg_red", "bg_green", "bg_blue", "bg_yellow", "bg_magenta",
        // "bg_cyan", "bg_white", "bg_black", "bg_bright_red",
